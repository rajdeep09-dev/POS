    ...
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="!fixed !inset-0 !max-w-none !w-screen !h-[100dvh] !m-0 !p-0 !border-none !bg-zinc-950 !flex !flex-col md:!flex-row overflow-hidden !rounded-none !shadow-none !ring-0 !transform-none !top-0 !left-0 !z-[5000]">
        ...
        <Tabs defaultValue="edit" className="w-full h-full flex flex-col md:flex-row gap-0">
          ...
          <TabsContent value="edit" className="flex-1 h-full md:w-[450px] md:max-w-[450px] md:shrink-0 bg-white border-r border-zinc-100 overflow-y-auto m-0">
            <div className="p-6 md:p-10 flex flex-col gap-8 min-h-full">
              ...
              <div className="space-y-6 text-left">
                ...
                <div className="space-y-4 pt-6 border-t border-zinc-100">
                  ...
                  <div className="space-y-3 p-5 bg-zinc-50/50 rounded-[2.5rem] border border-zinc-100 shadow-inner">
                    ...
                    <div className="grid grid-cols-3 gap-3">
                      ...
                      <div className="space-y-1">
                        <span className="text-[8px] font-black text-zinc-400 block uppercase pl-2">Amount</span>
              ...
              >
                ...
                <div className="space-y-8">
                  ...
                  <section>
                    ...
                    <div className="grid grid-cols-2 gap-12 px-2">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="text-[10pt] font-bold text-zinc-400 uppercase text-zinc-400">TRIPURA - 799114</div>
                      </div>
                    </div>
                  </section>
                  ...
                  <section>
                    ...
                    <div className="px-2 text-[11pt]">
                      <div className="text-zinc-600 uppercase font-bold tracking-tight">Transporter ID & Name: <span className="text-zinc-900 font-black">16BFOPD3349R1ZT & {details.transporter.toUpperCase()}</span></div>
                    </div>
                  </section>
                    ...
                    <table className="w-full border-collapse border-2 border-black text-[10pt]">
                      ...
                      <tbody>
                        <tr className="h-[12mm]">
                          ...
                          <td className="border-r-2 border-black text-center font-black uppercase text-[14pt] tracking-tighter">{details.vehicleNo.toUpperCase()}</td>
                ...
                <div className="mt-auto pt-12 flex flex-col items-center gap-4">
                  <div className="w-[120mm] h-[15mm] border-2 border-black flex items-center justify-center relative bg-white">
                    ...
                    <div className="absolute -bottom-6 font-black tracking-[1.2em] text-[10pt] pl-4">{details.no.replace(/\s/g, '').toUpperCase()}</div>
                  </div>
                </div>
              </div>
            </div>
